...
var app = new vue__WEBPACK_IMPORTED_MODULE_1___default.a({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://127.0.0.1:8000/api/views').then(function (response) {
      /* console.log(response.data.response); */
      _this.items = response.data.response;
      ...
      _this.items.forEach(function (element) {
        if (!_this.properties.includes(element.property_id)) {
          _this.properties.push(element.property_id);
        }
      });
      ...
      var _loop = function _loop() {
        ...
        _this.viewsNumber = [].concat(_toConsumableArray(_this.viewsNumber), [tempArray.length]);
        tempArray = [];
        i++;
      };

      while (i < _this.properties.length) {
        _loop();
      }
      ...
      var viewChart = new Chart(myChart, {
        ...
        data: {
          ...
          //visite per id show
          datasets: [{
            label: 'Visite' + ' ' + propertyName,
            //visite per id show
            data: [_this.viewsPerId.length //visite per id show
            ],
            backgroundColor: ['coral', 'cyan'],
            borderWidth: 1,
            borderColor: 'black',
            hoverBorderWidth: 3
          }]
