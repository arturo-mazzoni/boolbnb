                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td class="operations-button">
                                              ...
                                              <a href="{{ route('property.show', $property->id) }}" class="btn bottone border-radius-20">Dettagli</a>
                                              <a href="{{ route('property.edit', $property->id) }}" class="btn bottone border-radius-20">Modifica</a>
                                              <form action="{{ route('property.destroy', $property->id) }}" class="d-inline-block" method="POST">
                                                  @method('DELETE')
                                                  @csrf
                                                  <button class="btn bottone-rosso border-radius-20">Elimina</button>
                                              </form>
                                          </td>
                                        </tr>
                                        @endforeach
