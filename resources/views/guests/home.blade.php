...
{{-- <div class="my-jumbotron">
  ...
  <section>
    ...
    <div class="slider-sponsorizzati container my-4">
        ...
        <div id="multi-item-example" class="carousel slide carousel-multi-item" data-ride="carousel">
          ...
          <div class="controls-top">
            <a class="btn-floating sinistra" href="#multi-item-example" data-slide="prev"><i class="fa fa-chevron-left mr-5"></i></a>
            <a class="btn-floating destra" href="#multi-item-example" data-slide="next"><i class="fa fa-chevron-right ml-5"></i></a>
          </div>
          <!--/.Controls-->
    ...
    {{-- sezione in evidenza vecchio, di prova  --}}
